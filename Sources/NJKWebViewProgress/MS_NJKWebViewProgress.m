...
const float MS_NJKInitialProgressValue = 0.1f;
const float MS_NJKInteractiveProgressValue = 0.5f;
const float MS_NJKFinalProgressValue = 0.9f;

@implementation MS_NJKWebViewProgress
{
...
- (void)startProgress {
    if (_progress < MS_NJKInitialProgressValue) {
        [self setProgress:MS_NJKInitialProgressValue];
    }
}

- (void)incrementProgress {
    float progress = self.progress;
    float maxProgress = _interactive ? MS_NJKFinalProgressValue : MS_NJKInteractiveProgressValue;
